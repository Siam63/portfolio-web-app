...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="md:px-20 bg-white lg:px-30 px-10 dark:bg-gray-800">
        <section className="min-h-screen">
          ...
          <div className="dark:text-gray-300 mx-auto text-center">
        ...
        <section>
        <h1 className="text-center text-2xl mt-10 dark:text-gray-200">Portfolio - Previous Projects</h1>
          <div className="lg:flex gap-5 justify-center">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
              ...
              <div className="flex justify-center p-10 border-solid border-sky-200 border-2">
          ...
          <div className="lg:flex gap-5 justify-center">
            <div className="dark:bg-white text-center shadow-lg p-10 rounded-xl my-10">
              ...
              <div className="flex justify-center p-10 border-2 border-sky-200">
                <Image className="rounded-full object-cover transform transition-all hover:scale-125 delay-100" src={gpaCalc}></Image>
              </div>
          ...
          <div>
            <div className="dark:bg-white text-center shadow-lg p-10 rounded-xl my-10">
              ...
              <div className="md:flex-row flex justify-center p-10 flex-col border-solid border-sky-200 border-2">
        ...
        <section>
          <div>
            <h1 className="text-3xl py-5 dark:text-white text-center">Technologies I Have Worked With</h1>
            <div className="flex justify-evenly">
              <Image class="shadow-lg border-solid border-gray-500 border-2 object-fill transition ease-in-out delay-50 hover:scale-125" src={mongo_pic} height={150} width={150}/>
              <Image class="shadow-lg border-solid border-gray-500 border-2 object-cover transition ease-in-out delay-50 hover:scale-125" src={node_pic} height={150} width={150}/>
              <Image class="shadow-lg border-solid border-gray-500 border-2 object-cover transition ease-in-out delay-50 hover:scale-125" src={python_pic} height={150} width={150}/>
              <Image class="shadow-lg border-solid border-gray-500 border-2 object-cover transition ease-in-out delay-50 hover:scale-125" src={html_pic} height={150} width={150}/>
              <Image class="shadow-lg border-solid border-gray-500 border-2 object-cover transition ease-in-out delay-50 hover:scale-125" src={java_pic} height={150} width={150}/>
            </div>

            <div className="flex justify-evenly pb-10 mt-5">
              <Image class="shadow-lg border-solid border-gray-500 border-2 object-cover transition ease-in-out delay-50 hover:scale-125" src={react_pic} height={150} width={150}/>
              <Image class="shadow-lg border-solid border-gray-500 border-2 object-cover transition ease-in-out delay-50 hover:scale-125" src={swift_pic} height={150} width={150}/>
              <Image class="shadow-lg border-solid border-gray-500 border-2 object-cover transition ease-in-out delay-50 hover:scale-125" src={xcode_pic} height={150} width={150}/>
              <Image class="shadow-lg border-solid border-gray-500 border-2 object-cover transition ease-in-out delay-50 hover:scale-125" src={sql_pic} height={150} width={150}/>
              <Image class="shadow-lg border-solid border-gray-500 border-2 object-cover transition ease-in-out delay-50 hover:scale-125" src={tailwind_pic} height={150} width={150}/>
            </div>
          </div>
        </section>
      </main>
          
      <div className=" dark:bg-slate-800 flex justify-end pr-5 pb-5">
        <a href="#" className="shadow-lg rounded-3xl text-xl bg-slate-400 p-3 text-teal-800 hover:cursor-pointer hover:text-teal-600 hover:bg-gray-300 transition-all">
          ^ Back to Top
        </a>
      </div>
    </div>
