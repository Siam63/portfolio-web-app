        ...
        <div>
          ...
          <div className="lg:flex gap-5 justify-center">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
              ...
              <a href="https://github.com/Anthony-BouKhalil/SCSStoreWebApp" target="_blank" class="hover:scale-125 transition-all delay-75 relative items-center justify-center inline-block mt-5 px-5 p-3 overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group">
            ...
            <div className="dark:text-gray-700 dark:bg-white text-center shadow-lg p-10 rounded-xl my-10">
              ...
              <a href="https://github.com/Siam63/movie_recommender" target="_blank" class="mt-12 hover:scale-125 transition-all delay-75 relative items-center justify-center inline-block p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group">
                <span class="absolute top-0 left-0 w-40 h-40 -mt-10 -ml-3 transition-all duration-700 bg-green-500 rounded-full blur-md ease"></span>
                <span class="absolute inset-0 w-full h-full transition duration-700 group-hover:rotate-180 ease">
                <span class="absolute bottom-0 left-0 w-24 h-24 -ml-10 bg-teal-500 rounded-full blur-md"></span>
                <span class="absolute bottom-0 right-0 w-24 h-24 -mr-10 bg-blue-400 rounded-full blur-md"></span>
          ...
          <div className="lg:flex gap-5 justify-center">
            <div className="dark:bg-white text-center shadow-lg p-10 rounded-xl my-10">
              ...
              <p>HTML and CSS</p>
              <p>Hosted via Heroku</p>
              <a href="https://github.com/Siam63/gpa-calculator" target="_blank" class="hover:scale-125 transition-all delay-75 relative items-center justify-center inline-block mt-5 p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group">
                <span class="absolute top-0 left-0 w-40 h-40 -mt-10 -ml-3 transition-all duration-700 bg-green-500 rounded-full blur-md ease"></span>
                <span class="absolute inset-0 w-full h-full transition duration-700 group-hover:rotate-180 ease">
                <span class="absolute bottom-0 left-0 w-24 h-24 -ml-10 bg-teal-500 rounded-full blur-md"></span>
                <span class="absolute bottom-0 right-0 w-24 h-24 -mr-10 bg-blue-400 rounded-full blur-md"></span>
            ...
            <div className="dark:bg-white text-center shadow-lg p-10 rounded-xl my-10">
              ...
              <p>PyGame</p>
              <p>Python</p>
              <a href="https://github.com/Siam63/qix_game" target="_blank" class="hover:scale-125 transition-all delay-75 relative items-center justify-center inline-block mt-5 p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group">
                <span class="absolute top-0 left-0 w-40 h-40 -mt-10 -ml-3 transition-all duration-700 bg-green-500 rounded-full blur-md ease"></span>
                <span class="absolute inset-0 w-full h-full transition duration-700 group-hover:rotate-180 ease">
                <span class="absolute bottom-0 left-0 w-24 h-24 -ml-10 bg-teal-500 rounded-full blur-md"></span>
                <span class="absolute bottom-0 right-0 w-24 h-24 -mr-10 bg-blue-400 rounded-full blur-md"></span>
          ...
          <div>
            <div className="dark:bg-white text-center shadow-lg p-10 rounded-xl my-10">
              ...
              <p>FireBase Auth</p>
              <p>FireBase DB</p>
              <a href="https://github.com/Siam63/FinancialTracker" target="_blank" class="hover:scale-125 transition-all delay-75 relative inline-flex items-center justify-center mt-5 p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group">
                <span class="absolute top-0 left-0 w-40 h-40 -mt-10 -ml-3 transition-all duration-700 bg-green-500 rounded-full blur-md ease"></span>
                <span class="absolute inset-0 w-full h-full transition duration-700 group-hover:rotate-180 ease">
                <span class="absolute bottom-0 left-0 w-24 h-24 -ml-10 bg-teal-500 rounded-full blur-md"></span>
                <span class="absolute bottom-0 right-0 w-24 h-24 -mr-10 bg-blue-400 rounded-full blur-md"></span>
