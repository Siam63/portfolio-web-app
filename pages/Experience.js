...
const Experience = () => {
    ...
    return (
        <div name="experience" className="dark:bg-gradient-to-tr dark:from-gray-900 dark:to-teal-900 w-full h-screen rounded-3xl shadow-lg dark:shadow-sky-600 shadow-gray-700">        
