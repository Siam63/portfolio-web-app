...
const Experience = () => {
    ...
    return (
        <div name="experience" className="mt-[-100px] mb-[-20px] dark:bg-gradient-to-tr dark:from-gray-900 dark:to-sky-800 w-full h-full rounded-3xl shadow-md dark:shadow-sky-600 shadow-gray-700">        
